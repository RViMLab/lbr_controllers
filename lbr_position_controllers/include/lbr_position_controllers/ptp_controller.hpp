#ifndef LBR_POSITION_CONTROLLERS__LBR_POSITION_CONTROLLER_HPP_
#define LBR_POSITION_CONTROLLERS__LBR_POSITION_CONTROLLER_HPP_
...
#include "lbr_position_controllers/ramp.hpp"

namespace lbr_position_controllers {
class PTPController : public controller_interface::ControllerInterface {
public:
  PTPController();
...
protected:
  ...
  rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr
      position_command_subscription_;  // action?

  std::vector<std::string> joint_names_;
  std::vector<double> current_position_, position_command_;
...
#endif // LBR_POSITION_CONTROLLERS__LBR_POSITION_CONTROLLER_HPP_
